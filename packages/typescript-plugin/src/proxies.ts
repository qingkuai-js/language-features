...
// export function proxyGetCompletionEntryDetails() {
//     const getCompletionEntryDetails = languageService.getCompletionEntryDetails
//     languageService.getCompletionEntryDetails = (...args) => {
//         const res = getCompletionEntryDetails.call(languageService, ...args)
//         if (res?.codeActions) {
//             res.codeActions = res.codeActions.map(action => {
//                 return {
//                     ...action,
//                     description: m2r(action.description)
//                 }
//             })
//         }
//         return res
...
// export function proxyGetCompletionsAtPosition() {
//     const getCompletionsAtPosition = languageService.getCompletionsAtPosition
//     languageService.getCompletionsAtPosition = (...args) => {
//         const res = getCompletionsAtPosition.call(languageService, ...args)
//         res?.entries.forEach(entry => {
//             if (entry.source) {
//                 entry.source = m2r(entry.source)
//             }
//         })
//         return res
//     }
