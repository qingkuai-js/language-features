...
export const connectTsPluginServerFailed = `Failed to connect to typescript-plugin-qingkuai ipc server within one minute, please check whether the vscode built-in typescript-language-features extension is enabled.`
