...
const connection = rpc.createMessageConnection(new rpc.IPCMessageReader(childProcess), new rpc.IPCMessageWriter(childProcess));
connection.listen();
// 调试消息输出通道
connection.onNotification(LS_HANDLERS.TestLog, msg => {
    console.log(msg);
});
