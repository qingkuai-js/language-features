import { assertRange, createRange, formatSourceCode, openContentAsTextDocument } from "../../shared-util/tests";
...
describe("Html tag renaming functions:", () => {
    ...
    it("should receive null when a position is not in tag range.", async () => {
        ...
        const assertPrepareAsNull = async (line, character) => {
...
async function prepareRename(line, character) {
...
async function rename(line, character, newName) {
